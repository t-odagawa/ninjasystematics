...
void MergeDetectorCovMat(int kinematics = 0) {
  ...
  TString errfilename = "/hsm/nu/ninja/pra_tmp/detsys/bin_err";
  ...
  for ( int i = 0; i < npar; i++ ) {
    TString filename = "/hsm/nu/ninja/pra_tmp/detsys/covariance_matrix";
    filename += "/";
...
TString GetDialName(int i) {
  ...
  case 7 : return "VphMean";
  case 8 : return "VphSigma";
  case 9 : return "MaterialThickness";
  case 10 : return "PhysicsList";
