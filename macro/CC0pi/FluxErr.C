...
void FluxErr() {
  ...
  for ( int ifile = 0; ifile < 3; ifile++ ) {
    ...
    if ( ifile == 0 ) filename = "/hsm/nu/ninja/pra_tmp/CC0pi_20221213/signal/output/output_mode0.root"; // multiplicty
    else if ( ifile == 1 ) filename = "/hsm/nu/ninja/pra_tmp/CC0pi_20221213/signal/output/output_mode2.root"; // momentum
    else if ( ifile == 2 ) filename = "/hsm/nu/ninja/pra_tmp/CC0pi_20221213/signal/output/output_mode3.root"; // angle
