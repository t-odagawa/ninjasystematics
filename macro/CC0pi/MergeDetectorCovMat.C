...
void MergeDetectorCovMat(int kinematics = 13) {

  TString general_filename = GetGeneralFileName(kinematics);
  TString bin_err_filename = GetBinErrFileName(kinematics);

  TString ofilename = "/hsm/nu/ninja/pra_tmp/CC0pi_20221213/detsys/covariance_matrix";
  ...
  TString errfilename = "/hsm/nu/ninja/pra_tmp/CC0pi_20221213/detsys/bin_err";
