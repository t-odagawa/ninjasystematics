void DrawResult() {
  ...
  // TString filename = "/hsm/nu/ninja/pra_tmp/CC0pi_20221213/signal/output/output_mode0.root.hist_flux_p.toymc.root";
  // TString filename = "/hsm/nu/ninja/pra_tmp/CC0pi_20221213/signal/output/output_mode2.root.hist_flux_p_total.toymc.root";
  TString filename = "/hsm/nu/ninja/pra_tmp/CC0pi_20221213/signal/output/output_mode3.root.hist_flux_p_deg.toymc.root";
  TFile *file = new TFile(filename, "read");
  auto hsignal = (TH2D*)file->Get("hsignal");
  auto tree = (TTree*)file->Get("tree");

  // TString ofilename = "/hsm/nu/ninja/pra_tmp/CC0pi_20221213/fluxsys/bin_err/hist_flux_proton_multi.root";
  // TString ofilename = "/hsm/nu/ninja/pra_tmp/CC0pi_20221213/fluxsys/bin_err/hist_flux_proton_mom.root";
  TString ofilename = "/hsm/nu/ninja/pra_tmp/CC0pi_20221213/fluxsys/bin_err/hist_flux_proton_deg.root";
